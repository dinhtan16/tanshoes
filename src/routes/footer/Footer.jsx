...
const Footer = () => {
  return (
    <>
      ...
      <div className="grid grid-cols-4 items-center lg:flex lg:items-center lg:justify-center lg:gap-4
      md:items-center md:justify-center md:gap-4
      bg-gray-900 text-white py-4 font-light mt-8 text-center">
        <span><a href="https://www.adidas.com.vn/en/privacy_policy" className="border-r-2  pr-6 text-white font-light text-[12px]"> Privacy and policy</a></span>
       <span> <Link to ='/' className="border-r-2 pr-6 text-white font-light text-[12px]">Terms and Conditions</Link></span>
        <span><Link to ='/' className="border-r-2 pr-6 text-white font-light text-[12px]">Imprint</Link></span>
